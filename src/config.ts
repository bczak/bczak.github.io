...
export const config = {
  ...
  years: {
    ...
    '2022': { title: 'Эпизод XXII', caption: 'Тихий год. Один кадр: закат, парк и ничего лишнего.' },
    ...
    '2018': { title: 'Эпизод XVIII', caption: 'Совершеннолетие. Набережная, ужин и первый сбор всех вместе.' },
